...
namespace InfSystBusStation {
	...
	System::Void AuthForm::change_pass_Click(System::Object^ sender, System::EventArgs^ e)
	{
		...
		{
			// Получаем новый пароль из формы - БЕЗ СКОБОК!
			String^ newPassword = changeForm->NewPassword;

			// Можно добавить что-то делать с паролем
			MessageBox::Show(L"Новый пароль: " + newPassword +
				L"\n(В будущем будет сохранен в системе)",
